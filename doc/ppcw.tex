...
Next the critical section of the program was optimized.

% pairwise forces: 1st removing collided and threshold to constant

% then dpos, ddpos in inner pairwise loop

% then force to array syntax

% then temporal variable for saving force and only inverting force in
% if statement (reduce impact of branch)

% here start w. vectorization
% vectorization with openmp

% inversing array

% ratio of pairwise <-> not pairwise still the same (VTune)
