...
\texttt{-no-vec} flag.
The last part of phase three was to make the code vectorize.

% pseudo code to make describing easier

% just enable vec (-xCORE-AVX2 and -vec-threshold0)

% vectorization with openmp and temp variable

% fuse into one n loop
